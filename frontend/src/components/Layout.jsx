...
const NAV = [
  ...
  { section: 'LICENSES', items: [
    ...
    { to: '/renewals', label: 'Renewals', icon: Bell },
  ]},
  { section: 'ADMIN', items: [
...
function Grid({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg> }
function File({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> }
function Bell({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg> }
function Users({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> }
function Shield({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> }
function Person({ active }) { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={active ? '#7c5cfc' : '#6b6b8a'} strokeWidth="2" strokeLinecap="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> }
...
const s = {
  ...
  navItem: { display: 'flex', alignItems: 'center', gap: 9, padding: '7px 10px', borderRadius: 7, fontSize: 13, color: '#9090aa', textDecoration: 'none', marginBottom: 1 },
